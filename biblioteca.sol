contract Library{
    ...
    function Library() {
        ...
        books.push(Book({originalOwner: this, currentOwner: this, isbn: 0, copy: 0, available: false}));
        ...
        only_current_members(msg.sender)
    {
        ...
        uint bookId = books.push(Book({originalOwner: msg.sender, currentOwner: msg.sender, isbn: isbn, copy: copy, available: true})) - 1;
